function Navbar() {
    return (
        <header className="fixed inset-x-0 top-0 z-30 w-full py-4 shadow backdrop-blur-lg bg-white bg-opacity-30 md:top-6 md:rounded-3xl lg:max-w-screen-xl border-b border-gray-200">
        <div className="px-6">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex md:items-center md:gap-6 ">
              <a
                href="#rendez-vous"
                className="rounded-lg px-3 py-2 text-sm font-medium text-gray-700 transition duration-200 hover:bg-gray-100 hover:text-gray-900"
              >
                Rendez-vous
              </a>
              <a
            ...
            <div className="flex items-center gap-3">
              <a
                href="/login/patient"
                className="hidden items-center justify-center rounded-full bg-gray-200 px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm ring-1 ring-gray-300 transition duration-200 hover:bg-gray-300 hover:ring-gray-400 sm:inline-flex"
              >
                Connexion Patient
              </a>
              ...
              <a
                href="/signup"
                className="inline-flex items-center justify-center rounded-full bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition duration-200 hover:bg-blue-500 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-blue-600"
              >
                S'inscrire
              </a>
            </div>
