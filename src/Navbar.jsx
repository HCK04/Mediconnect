...
function Navbar() {
  return (
    <header className="fixed inset-x-0 top-0 z-30 w-full py-4 shadow-lg shadow-gray-300 backdrop-blur-lg bg-white bg-opacity-80 md:top-0 md:rounded-b-3xl lg:max-w-screen-xl border-b border-gray-200">
      <div className="px-6">
        <div className="flex items-center justify-between">
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="md:hidden inline-flex items-center justify-center rounded-lg p-2 text-gray-600 transition duration-200 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-300"
