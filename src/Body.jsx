...
<section id="features" className="py-20 lg:pb-40 lg:pt-48">
  <div className="container mx-auto text-center">
    <h2 className="text-3xl lg:text-5xl font-semibold">Fonctionnalités principales</h2>
    <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
      <div className="flex-1 px-3">
        ...
        >
          <p className="font-semibold text-xl">Service Un</p>
          <p className="mt-4">
            Un service qui offre une expérience utilisateur fluide avec une interface intuitive et des fonctionnalités adaptées à vos besoins spécifiques.
          </p>
        </div>
      </div>
      <div className="flex-1 px-3">
        <div
          ...
          style={{ boxShadow: '0 10px 28px rgba(0, 0, 0, .08)' }}
        >
          <p className="font-semibold text-xl">Service Deux</p>
          <p className="mt-4">
            Un service innovant pour vous aider à gérer vos tâches quotidiennes efficacement tout en restant connecté avec vos objectifs.
          </p>
        </div>
      </div>
      <div className="flex-1 px-3">
        <div
          ...
          style={{ boxShadow: '0 10px 28px rgba(0, 0, 0, .08)' }}
        >
          <p className="font-semibold text-xl">Service Trois</p>
          <p className="mt-4">
            Une solution robuste pour optimiser votre productivité et garantir des résultats exceptionnels dans tous vos projets.
          </p>
        </div>
      </div>
    </div>
            ...
            <div className="container mx-auto px-16 items-center flex flex-col lg:flex-row">
                <div className="lg:w-1/2">
                    <div className="lg:pr-32 xl:pr-48">
                        ...
                        <p className="mt-8 text-xl font-light leading-relaxed">Our team of enthusiastic marketers
                    ...
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1113.58 784.41">
                        <defs>
                            <linearGradient id="a" x1="990.77" y1="609.55" x2="1147.32" y2="609.55"
                                ...
                                <stop offset="0" stopColor="gray" stopOpacity=".25"></stop>
                                <stop offset=".54" stopColor="gray" stopOpacity=".12"></stop>
                        ...
                        <path
                            ...
                            fill="#3f3d56"></path>
                        <path fill="none" stroke="#3f3d56" strokeLinecap="round" strokeMiterlimit="10"
                            strokeWidth="7" d="M318.5 385.41l130-145 130 73 130-224 130 107"></path>
            ...
            <div className="container mx-auto px-16 items-center flex flex-col lg:flex-row">
                <div className="lg:w-1/2">
                    <div className="lg:pl-32 xl:pl-48">
                        <h3 className="text-3xl font-semibold leading-tight">Design And Plan Your Business Growth
                            Steps</h3>
                        <p className="mt-8 text-xl font-light leading-relaxed">Once the market analysis process is
        ...
        <section className="py-20">
            <div className="container mx-auto px-16 items-center flex flex-col lg:flex-row">
                <div className="lg:w-1/2">
                    <div className="lg:pr-32 xl:pr-48">
                        <h3 className="text-3xl font-semibold leading-tight">Search For Performance Optimization
                        </h3>
                        <p className="mt-8 text-xl font-light leading-relaxed">With all the information in place you
        ...
        <section id="stats" className="py-20 lg:pt-32">
            <div className="container mx-auto text-center">
                <p className="uppercase tracking-wider text-gray-600">Our customers get results

                </p>
                <div className="flex flex-col sm:flex-row mt-8 lg:px-24">
                    <div className="w-full sm:w-1/3">
                        <p className="text-4xl lg:text-6xl font-semibold text-teal-500">+100%
                        </p>
                        <p className="font-semibold mb-6">Stats Information
                        </p>
                    </div>
                    <div className="w-full sm:w-1/3">
                        <p className="text-4xl lg:text-6xl font-semibold text-teal-500">+100%
        ...
        <section id="testimonials" className="py-20 lg:py-40">
            <div className="container mx-auto">
                <p className="uppercase tracking-wider mb-8 text-gray-600 text-center">What customers are saying
                </p>
                <div className="flex flex-col md:flex-row md:-mx-3">
                    <div className="flex-1 px-3">
                        <div className="p-12 rounded-lg border border-solid border-gray-200 mb-8"
                            ...
                            <div className="flex items-center mt-8"><img className="w-12 h-12 mr-4 rounded-full"
                                    src="https://placeimg.com/150/150/people" alt="Jane Doe"></img>
                                <div>
                                    <p>Jane Doe
                                    </p>
                    ...
                    <div className="flex-1 px-3">
                        <div className="p-12 rounded-lg border border-solid border-gray-200 mb-8"
                            ...
                            <div className="flex items-center mt-8"><img className="w-12 h-12 mr-4 rounded-full"
                                    src="https://placeimg.com/150/150/people" alt="John Doe"></img>
                                <div>
                                    <p>John Doe
                                    </p>
                                    <p className="text-sm text-gray-600">Director of Research and Data
                    ...
                    <div className="flex-1 px-3">
                        <div className="p-12 rounded-lg border border-solid border-gray-200 mb-8"
                            ...
                            <div className="flex items-center mt-8"><img className="w-12 h-12 mr-4 rounded-full"
                                    src="https://placeimg.com/150/150/people" alt="Jane Smith"></img>
                                <div>
                                    <p>Jane Smith
                                    </p>
                                    <p className="text-sm text-gray-600">Director of Research and Data
