        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 transition-opacity duration-300">
          <div className="bg-white p-8 rounded-xl shadow-lg w-96 transition-transform transform scale-95 opacity-100 animate-fadeIn">
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-semibold text-gray-800">Détails de l'utilisateur</h3>
              <button
            ...
            <div className="mt-6">
              ...
              <div className="space-y-3 text-gray-700">
                <p className="text-lg font-medium">Statut: 
                  <span
                    className={`inline-block px-3 py-1 text-xs font-semibold leading-tight rounded-full ${
                ...
                <p className="text-lg font-medium">Date d'inscription: <span className="text-gray-500">{selectedUser.date}</span></p>
                <p className="text-lg font-medium">Contact: <span className="text-gray-500">{selectedUser.contact}</span></p>
              </div>
            </div>
